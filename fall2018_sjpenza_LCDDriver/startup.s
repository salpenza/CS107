...
; Semester: Fall 2018
; Description: This is the startup file which sets up all of the vectors needed
; for the processor to function. It also sets up the start of the program by
; loading the address of the code "main" and jumping to it.
; 	
; Note that there is no setup of a runtime environment. You're programming to
; the metal here!
; 
; Based on: startup_LPC407x_8x.s
;
;******************************************************************************	
...
;******************************************************************************
; Create the vector table. Vector Table Mapped to Address 0 at Reset
;******************************************************************************
...
__Vectors		DCD		__initial_sp              ; Top of Stack
			...
			;	DCD		0xEFFFF5D6                ; Reserved- vector sum
				...
				AREA    SBCCSTARTUP, CODE, READONLY
;******************************************************************************
; Reset Handler
;
; This is where the code starts. All we do is load the address of "main" and
; branch to it.
;******************************************************************************
Reset_Handler	PROC
